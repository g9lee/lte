...
void test_suite_debug_print_crt( char *crt_file, char *file, int line, char *prefix,
                      char *result_str )
{
    x509_crt   crt;
    ssl_context ssl;
...
void test_suite_debug_print_mpi( int radix, char *value, char *file, int line,
...
int dep_check( char *str )
{
    ...
    if( strcmp( str, "POLARSSL_PEM_C" ) == 0 )
    {
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "debug_print_crt" ) == 0 )
    {
    #ifdef POLARSSL_FS_IO
    #ifdef POLARSSL_X509_CRT_PARSE_C
        ...
        test_suite_debug_print_crt( param1, param2, param3, param4, param5 );
        return ( 0 );
    #endif /* POLARSSL_FS_IO */
    #endif /* POLARSSL_X509_CRT_PARSE_C */
    ...
    if( strcmp( params[0], "debug_print_mpi" ) == 0 )
    {
        ...
        test_suite_debug_print_mpi( param1, param2, param3, param4, param5, param6 );
        return ( 0 );
