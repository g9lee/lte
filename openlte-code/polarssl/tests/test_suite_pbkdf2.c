...
void test_suite_pbkdf2_hmac( int hash, char *hex_password_string, char *hex_salt_string,
...
int main()
{
    ...
    const char *filename = "suites/test_suite_pbkdf2.data";
    FILE *file;
    char buf[5000];
    char *params[50];
