...
#ifdef POLARSSL_MD2_C
void test_suite_md2_hmac( int trunc_size, char *hex_key_string, char *hex_src_string,
...
#ifdef POLARSSL_MD4_C
void test_suite_md4_hmac( int trunc_size, char *hex_key_string, char *hex_src_string,
               char *hex_hash_string )
{
    unsigned char src_str[10000];
    unsigned char key_str[10000];
...
#ifdef POLARSSL_MD5_C
void test_suite_md5_hmac( int trunc_size, char *hex_key_string, char *hex_src_string,
               char *hex_hash_string )
{
    unsigned char src_str[10000];
    unsigned char key_str[10000];
...
void test_suite_md2_file( char *filename, char *hex_hash_string )
{
...
#ifdef POLARSSL_MD4_C
#ifdef POLARSSL_FS_IO
void test_suite_md4_file( char *filename, char *hex_hash_string )
{
    unsigned char hash_str[65];
    unsigned char output[33];
...
#ifdef POLARSSL_MD5_C
#ifdef POLARSSL_FS_IO
void test_suite_md5_file( char *filename, char *hex_hash_string )
{
    unsigned char hash_str[65];
    unsigned char output[33];
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "md2_hmac" ) == 0 )
    {
        ...
        test_suite_md2_hmac( param1, param2, param3, param4 );
        return ( 0 );
    #endif /* POLARSSL_MD2_C */
    ...
    if( strcmp( params[0], "md4_hmac" ) == 0 )
    {
        ...
        test_suite_md4_hmac( param1, param2, param3, param4 );
        return ( 0 );
    #endif /* POLARSSL_MD4_C */
    ...
    if( strcmp( params[0], "md5_hmac" ) == 0 )
    {
        ...
        test_suite_md5_hmac( param1, param2, param3, param4 );
        return ( 0 );
    #endif /* POLARSSL_MD5_C */
    ...
    if( strcmp( params[0], "md2_file" ) == 0 )
    {
        ...
        test_suite_md2_file( param1, param2 );
        return ( 0 );
    #endif /* POLARSSL_MD2_C */
    #endif /* POLARSSL_FS_IO */
    ...
    if( strcmp( params[0], "md4_file" ) == 0 )
    {
        ...
        test_suite_md4_file( param1, param2 );
        return ( 0 );
    #endif /* POLARSSL_MD4_C */
    #endif /* POLARSSL_FS_IO */
    ...
    if( strcmp( params[0], "md5_file" ) == 0 )
    {
        ...
        test_suite_md5_file( param1, param2 );
        return ( 0 );
    #endif /* POLARSSL_MD5_C */
    #endif /* POLARSSL_FS_IO */
...
int main()
{
    ...
    const char *filename = "suites/test_suite_mdx.data";
    FILE *file;
    char buf[5000];
    char *params[50];
