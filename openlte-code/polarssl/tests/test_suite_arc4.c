...
void test_suite_arc4_crypt( char *hex_src_string, char *hex_key_string,
                 char *hex_dst_string )
{
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "arc4_crypt" ) == 0 )
    {
        ...
        test_suite_arc4_crypt( param1, param2, param3 );
        return ( 0 );
...
int main()
{
    ...
    const char *filename = "suites/test_suite_arc4.data";
    FILE *file;
    char buf[5000];
    char *params[50];
