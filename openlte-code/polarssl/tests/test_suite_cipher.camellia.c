...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "POLARSSL_CIPHER_CAMELLIA_256_CBC" ) == 0 )
    {
        *value = ( POLARSSL_CIPHER_CAMELLIA_256_CBC );
        return( 0 );
    }
    ...
    if( strcmp( str, "POLARSSL_CIPHER_CAMELLIA_192_CBC" ) == 0 )
    {
        *value = ( POLARSSL_CIPHER_CAMELLIA_192_CBC );
        return( 0 );
    }
